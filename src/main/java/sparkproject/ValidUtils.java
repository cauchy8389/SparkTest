...
public class ValidUtils {
	...
	public static boolean between(String data, String dataField, 
		...
		String startParamFieldStr = ParamUtils.getFieldFromConcatString(
				parameter, "\\|", startParamField);
		String endParamFieldStr = ParamUtils.getFieldFromConcatString(
		...
		String dataFieldStr = ParamUtils.getFieldFromConcatString(
				data, "\\|", dataField);
	...
	public static boolean in(String data, String dataField, 
		...
		String paramFieldValue = ParamUtils.getFieldFromConcatString(
		...
		String dataFieldValue = ParamUtils.getFieldFromConcatString(
				data, "\\|", dataField);
