...
"""
  ...
  val P = functionalprogramming.parsing.instances.Reference
  import functionalprogramming.parsing.instances.ReferenceTypes.Parser
  ...
  def mystring(w: String*) ={
    println("aa" :: w.toList)
  }

  mystring("asdss","sssaa")
